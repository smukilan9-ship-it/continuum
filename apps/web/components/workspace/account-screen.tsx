...
export function AccountScreen({ user, showToast }: { user: AuthUser; showToast: Toast }) {
  ...
  return <div className="screen account-screen">
    ...
    <div className="account-grid">
      <Card className="account-card"><div className="account-card-heading"><UserRound size={20} /><div><h2>Username</h2><p>{user.username}</p></div></div><div className="account-status verified">Active account</div><small className="field-hint">Password recovery is available from the sign-in page.</small></Card>
