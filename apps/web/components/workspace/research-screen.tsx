          ...
          <div className="research-tab-panel">
            ...
            {activeTab === "discovery" ? <div className="research-discovery">
              <div className="research-section-heading">
                <div><h2>Discovery</h2><p>Everything found here is filed into <strong>{text(selectedProject, "title")}</strong>. Paper search spans OpenAlex and Crossref; the scholarly graph adds authors, institutions, sources, topics, and citation links.</p></div>
