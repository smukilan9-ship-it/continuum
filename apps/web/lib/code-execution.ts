...
export type ExecutionStatus = "preparing" | "loading_python" | "loading_sql" | "running" | "testing";
...
export const LANGUAGE_RUNTIME_NOTES: Record<RunnableLanguage, string> = {
  python: "Python 3.14 in a local Pyodide WebAssembly worker. Its virtual filesystem is discarded after every run.",
  javascript: "JavaScript in a disposable Web Worker with network APIs disabled and a hard wall-clock timeout.",
