...
![Home. One next action with the reason it was chosen, a week built by the constraint solver, and today's agenda.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/01-home-today.png)

*Home. One next action with the reason it was chosen, a week built by the constraint solver, and today's agenda.*
...
![The week grid. Every block placed by the solver against deadlines, prerequisites and fixed commitments. No model was called.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/02-plan-week.png)

*The week grid. Every block placed by the solver against deadlines, prerequisites and fixed commitments. No model was called.*
...
![Study status. Concepts carry mastery evidence rather than a completion percentage, and open misconceptions are named.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/04-learn-status.png)

*Study status. Concepts carry mastery evidence rather than a completion percentage, and open misconceptions are named.*
...
![The same class of question, answered from the workspace. Two accepted decisions and a source passage, each an openable citation chip.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/09-ask-grounded.png)

*The same class of question, answered from the workspace. Two accepted decisions and a source passage, each an openable citation chip.*
...
![One task, one route. The branch that matters most is the first: scheduling never reaches a model.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/diagram-routing.png)

*One task, one route. The branch that matters most is the first: scheduling never reaches a model.*


![The Context screen. Every routing decision is recorded with the reason it was taken and what verified it.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/10-context-routing.png)

*The Context screen. Every routing decision is recorded with the reason it was taken and what verified it.*
...
![A work opened from Discover, with its references, citations and related papers. Saving it indexes the passages that answers can then cite.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/08-library-citation-graph.png)

*A work opened from Discover, with its references, citations and related papers. Saving it indexes the passages that answers can then cite.*
...
![The assistant's chain. Four retrieval legs run concurrently under deadlines; a general question runs none of them.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/diagram-retrieval.png)

*The assistant's chain. Four retrieval legs run concurrently under deadlines; a general question runs none of them.*
...
![The concept map for a goal. Branches are learning jobs, and only saved dependencies become prerequisites.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/03-goal-concept-map.png)

*The concept map for a goal. Branches are learning jobs, and only saved dependencies become prerequisites.*
...
![Review. Every proposed change waits here as a field-level diff with a risk label. Nothing lands without approval.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/05-review-proposals.png)

*Review. Every proposed change waits here as a field-level diff with a risk label. Nothing lands without approval.*
...
![The MCP consent screen. Each scope is a separate checkbox in plain English, badged read-only or can-make-changes. PKCE protected, short-lived, revocable.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/15-mcp-authorize.png)

*The MCP consent screen. Each scope is a separate checkbox in plain English, badged read-only or can-make-changes. PKCE protected, short-lived, revocable.*
...
![Build. A sandboxed editor and console where runtime output is passed to the model as evidence, never as instruction.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/12-build-console.png)

*Build. A sandboxed editor and console where runtime output is passed to the model as evidence, never as instruction.*
...
![One search across goals, projects, sources, passages and memory. Opening a result never changes data.](https://raw.githubusercontent.com/smukilan9-ship-it/continuum/main/pr_assets/13-command-palette.png)

*One search across goals, projects, sources, passages and memory. Opening a result never changes data.*
