...
- Made assistant proposal approval and accepted research-decision writes app-only. Schedule confirmation and commit remain separate operations; no external calendar write is claimed.
